...
def affine_norm_relu_forward(x, w, b, mode, gamma, beta, bn_param):
    """Convenience layer that performs an affine transform followed by a ReLU, and a batchnorm.
...
def affine_norm_relu_backward(dout, cache, mode):
    ...
    da, dgamma, dbeta = None, None, None
    if mode == 'batchnorm':
